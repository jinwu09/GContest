      ...
      <div class="row my-3">
        <div class="col-3">
          <div class="btn-group w-100">
            <button
              type="button"
              class="btn btn-primary dropdown-toggle w-100 hvr-grow-rotate"
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item hvr-grow-rotate" href="#">5</a></li>
              <li><a class="dropdown-item hvr-grow-rotate" href="#">10</a></li>
              <li><a class="dropdown-item hvr-grow-rotate" href="#">15</a></li>
              <li><a class="dropdown-item hvr-grow-rotate" href="#">20</a></li>
            </ul>
          </div>
        </div>
        <div class="col-3">
        ...
        <div class="col-3">
          <div class="w-100 btn btn-success hvr-wobble-bottom">Save</div>
        </div>
      </div>
        ...
        <div class="col-12 d-flex align-items-baseline" >
          <div class="w-25 p-2 questionBox1 rounded m-2" action="#" method="post">
            ...
            <textarea
              name="text"
              oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"'
              class="rounded text-center text-capitalize noBorder w-100 questionBoxColor1"
          ...
          <div class="w-25 p-2 questionBox2 rounded m-2">
            ...
            <textarea
              name="text"
              oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"'
              class="rounded text-center text-capitalize noBorder w-100 questionBoxColor2"
              placeholder="Edit Answer"
            ></textarea>
          </div>
          <div class="w-25 p-2 questionBox3 rounded m-2">
            ...
            <textarea
              name="text"
              oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"'
              class="rounded text-center text-capitalize noBorder w-100 questionBoxColor3"
              placeholder="Edit Answer"
            ></textarea>
          </div>
          <div class="w-25 p-2 questionBox4 rounded m-2">
            ...
            <textarea
              name="text"
              oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"'
              class="rounded text-center text-capitalize questionBoxColor4 noBorder w-100"
              placeholder="Edit Answer"
            ></textarea>
...
input:checked + .slider {
  content: 'Correct';
  background-color: #6d9c6f !important;
}
