...
<template>
    ...
    <div class="container-fluid d-flex">
        ...
        <div class="col-10">
            ...
            <div class="row my-3">
                <div class="col-3">
                    <div class="btn-group w-100">
                        <button type="button" class="btn btn-primary dropdown-toggle w-100 hvr-grow-rotate" data-bs-toggle="dropdown" aria-expanded="false">
                            Point Dropdown
                        </button>
            ...
            <div row="row mt-3">
                <div class="col-12">
                    <textarea name="text" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"' class="rounded align-center text-center noBorder bigTextbox w-100 px-3 py-5" placeholder="Edit Question"></textarea>
                </div>
            </div>
